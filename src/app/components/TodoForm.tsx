    ...
    >
      <div className="mb-4">
        ...
        <input
          ...
          className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:outline-none transition-colors duration-200 ${
            error
      ...
      <div className="flex items-center mb-4">
        <div className="w-1/2 pr-2">
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 focus:outline-none transition-colors duration-200"
          >
